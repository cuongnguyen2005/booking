...
class _CustomerInfoState extends State<CustomerInfo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          const TopBarDefault(text: 'Thông tin khách hàng'),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                const InputDefault(
                    hintText: 'Ví dụ: Nguyễn Văn A', obscureText: false),
                const SizedBox(height: 16),
                Text(
                  'Số điện thoại',
                  style: tStyle.MediumBoldBlack(),
                ...
                const SizedBox(height: 8),
                const InputDefault(
                    hintText: 'Ví dụ: 0349645382', obscureText: false),
                const SizedBox(height: 16),
                Text(
                  'Email',
                  style: tStyle.MediumBoldBlack(),
                ...
                const SizedBox(height: 8),
                const InputDefault(
                    hintText: 'Ví dụ: demo@gmail.com', obscureText: false),
              ],
            ),
          ),
        ],
