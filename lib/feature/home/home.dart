...
import 'package:booking/components/bottom_sheet/bottom_sheet.dart';
...
import 'package:booking/feature/home/widget/location_find.dart';
import 'package:booking/feature/home/widget/location_small_widget.dart';
                  ...
                  children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          SearchBoxSecondary(
                            ...
                            night: selectedRangeDate.duration.inDays,
                            onTap: onTapShowRangeTime,
                          ),
                          const SizedBox(height: 10),
                          SearchBoxPrimary(
                            title: 'Loại phòng và khách',
                            content: 'phòng đơn, $people khách',
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: 7,
                        itemBuilder: (context, index) {
                          return const LocationSmallWidget(
                            image: 'assets/images/1024.png',
                            nameHotel: 'The Aston Vill Hotel',
                            addressHotel: 'Alice Spings NT 0870 Australia',
                            price: '\$200,7',
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  Column(
                    children: [
                      const BottomSheetWidget(text: 'Chọn loại phòng và khách'),
